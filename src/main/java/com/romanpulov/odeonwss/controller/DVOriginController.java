...
public class DVOriginController extends AbstractEntityServiceRestController<DVOrigin, DVOriginDTO, DVOriginRepository, DVOriginService> {
    ...
    @GetMapping("/table")
    ResponseEntity<List<DVOriginDTO>> getDvOrigins() {
        return ResponseEntity.ok(dvOriginRepository.findAllDTO());
    }
}
